# El codigo tambien se encuentra en google colab
# https://colab.research.google.com/drive/1V3YPi8S0r9cAOL3UgJiguCJ5Kz94keli?usp=sharing#scrollTo=u0oPi4J-_Bto
# Es un poco mas facil de ver ahi
...
# Calcular el cubrimiento empirico con ambos metodos

#Para cada experimento se obtienen k muestras aleatorias y para cada una se calcula si el intervalo de confianza contiene el valor real de p. 

#De todas las k muestras aleatorias calculamos la proporcion de veces que el intervalo contenia al verdadero parametro.

#Observamos que cada vez que se volvia a correr el codigo la proporcion cambiaba ligeramente por ser los intervalos de confianza dependientes de la muestra aleatoria.

#Para entender bien la proporcion real se corrio el experimento k veces para cada combinacion de n y p para observar hacia que valores tiende la proporcion real y se tomo la media como valor representativo.
